        ...
        <div class="container">
            <div class="left">
                ...
                <div class="lp-form">
                    ...
                    <p style="text-align: justify; font-weight: 600;">⚠️ Quer ficar por dentro de tudo e saber as novidades em primeira mão? Entre no nosso grupo de <a href="" target="_blank" class="group-whatsapp">WhatsApp</a></p>
